    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                ...
                echo isset($_SESSION['username']) ? "<span style='font-size:14px;'> | Hi, " . $_SESSION['username'] . '</span>': "";
            ...
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-2 <?= ($data['page_title']) == "videos"? 'active':'';?>" href="<?=ROOT?>video">Videos</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-4 <?= ($data['page_title']) == "upload"? 'active':'';?>" href="<?=ROOT?>upload/image">Upload</a>
                </li>
            </ul>
            </div>
        </div>
