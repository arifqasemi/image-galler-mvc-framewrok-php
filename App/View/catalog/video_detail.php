<?php $this->view("catalog/header",$data); ?>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary"><?=$data['single_video_details']->title?></h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <video autoplay muted loop controls id="tm-video">
                    <source src="<?=ROOT . $data['single_video_details']->video ?>" type="video/mp4">
                </video>  
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="text-center mb-5">
                        <a href="<?=ROOT?>"Download class="btn btn-primary tm-btn-big">Download</a>
                    </div>                    
        ...
        <div class="row mb-3 tm-gallery">
            ...
            <?php  if(is_array($data ['rondom_video'])){
            foreach($data ['rondom_video'] as $row){
