<?php $this->view("catalog/header",$data); ?>
    ...
    <div class="container-fluid tm-container-content tm-mt-60">
        <div class="row mb-4">
            <h2 class="col-12 tm-text-primary"><?=$data['single_image']->title?></h2>
        </div>
        <div class="row tm-mb-90">            
            <div class="col-xl-8 col-lg-7 col-md-6 col-sm-12">
                <img src="<?=ROOT?><?=$data['single_image']->image?>" alt="Image" class="img-fluid">
            </div>
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="tm-bg-gray tm-video-details">
                    ...
                    <div class="text-center mb-5">
                        <a href="<?=$data['single_image']->image?>" download class="btn btn-primary tm-btn-big">Download</a>
                    </div>                    
        ...
        <?php  if(is_array($data ['rondom_image'])){
            foreach($data ['rondom_image'] as $row){
